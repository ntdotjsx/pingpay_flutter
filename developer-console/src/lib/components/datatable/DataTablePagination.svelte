...
<div class="flex flex-col gap-3 py-3 sm:flex-row sm:items-center sm:justify-between {className}">
  <!-- Row count info & rows per page selector -->
  <div class="flex items-center gap-3 text-xs text-[#615d59]">
    <span>
      ...
      <strong class="font-medium text-[#000000]">{table.rowCount.total}</strong> results
    </span>
